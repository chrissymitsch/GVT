var app = ( function() {
	...
	function initModels() {
        ...
        createRecursiveSphere("kugel", fs);
	}
    ...
    function createRecursiveSphere(geometryname, fillstyle) {
		sphere.fillstyle = fillstyle;
		initDataAndBuffers(sphere, geometryname);
		// Create and initialize Model-View-Matrix.
	...
	function render() {
        ...
        // Recursive sphere.
        mat4.copy(sphere.mvMatrix, camera.vMatrix);
